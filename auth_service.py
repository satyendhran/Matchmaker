...
class UserManagementService:
    ...
    def __init__(
        self, repository: IUserRepository, auth_service: AuthenticationService
    ):
        self.repository = repository
    ...
    def register_player(
        self, player_id: str, name: str, date_of_birth: str
    ) -> PlayerUser:
        ...
        if self.repository.get_player_by_name_dob(name, date_of_birth):
            raise ValueError(
                "Player with this name and date of birth already registered"
            )
    ...
    def suspend_user(self, user_id: str, admin_id: str, reason: str = None) -> None:
        ...
        self.repository.log_admin_action(
            ...
            "SUSPEND_USER",
            user_id,
            f"Suspended: {reason or 'No reason provided'}",
        )
    ...
    def shadow_ban_user(self, user_id: str, admin_id: str, reason: str = None) -> None:
        ...
        self.repository.log_admin_action(
            ...
            "SHADOW_BAN_USER",
            user_id,
            f"Shadow banned: {reason or 'No reason provided'}",
        )
